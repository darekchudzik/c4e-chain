...
type MsgVestingCession struct {
	Creator         string `protobuf:"bytes,1,opt,name=creator,proto3" json:"creator,omitempty"`
	ReceiverAddress string `protobuf:"bytes,2,opt,name=receiverAddress,proto3" json:"receiverAddress,omitempty"`
	Amount          uint64 `protobuf:"varint,3,opt,name=amount,proto3" json:"amount,omitempty"`
}

func (m *MsgVestingCession) Reset()         { *m = MsgVestingCession{} }
func (m *MsgVestingCession) String() string { return proto.CompactTextString(m) }
func (*MsgVestingCession) ProtoMessage()    {}
func (*MsgVestingCession) Descriptor() ([]byte, []int) {
	return fileDescriptor_4e660f335ecf9868, []int{8}
}
func (m *MsgVestingCession) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgVestingCession) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgVestingCession.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgVestingCession) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgVestingCession.Merge(m, src)
}
func (m *MsgVestingCession) XXX_Size() int {
	return m.Size()
}
func (m *MsgVestingCession) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgVestingCession.DiscardUnknown(m)
}

var xxx_messageInfo_MsgVestingCession proto.InternalMessageInfo

func (m *MsgVestingCession) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
func (m *MsgVestingCession) GetReceiverAddress() string {
	if m != nil {
...
func (m *MsgVestingCession) GetAmount() uint64 {
	if m != nil {
		return m.Amount
	}
	return 0
...
type MsgVestingCessionResponse struct {
}

func (m *MsgVestingCessionResponse) Reset()         { *m = MsgVestingCessionResponse{} }
func (m *MsgVestingCessionResponse) String() string { return proto.CompactTextString(m) }
func (*MsgVestingCessionResponse) ProtoMessage()    {}
func (*MsgVestingCessionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_4e660f335ecf9868, []int{9}
}
func (m *MsgVestingCessionResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgVestingCessionResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgVestingCessionResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgVestingCessionResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgVestingCessionResponse.Merge(m, src)
}
func (m *MsgVestingCessionResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgVestingCessionResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgVestingCessionResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgVestingCessionResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*MsgVestingCession)(nil), "chain4energy.c4echain.cfevesting.MsgVestingCession")
	proto.RegisterType((*MsgVestingCessionResponse)(nil), "chain4energy.c4echain.cfevesting.MsgVestingCessionResponse")
}
...
var fileDescriptor_4e660f335ecf9868 = []byte{
	...
	,
}
...
type MsgClient interface {
	...
	VestingCession(ctx context.Context, in *MsgVestingCession, opts ...grpc.CallOption) (*MsgVestingCessionResponse, error)
}
...
func (c *msgClient) VestingCession(ctx context.Context, in *MsgVestingCession, opts ...grpc.CallOption) (*MsgVestingCessionResponse, error) {
	out := new(MsgVestingCessionResponse)
	err := c.cc.Invoke(ctx, "/chain4energy.c4echain.cfevesting.Msg/VestingCession", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	VestingCession(context.Context, *MsgVestingCession) (*MsgVestingCessionResponse, error)
}
...
func (*UnimplementedMsgServer) VestingCession(ctx context.Context, req *MsgVestingCession) (*MsgVestingCessionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method VestingCession not implemented")
}
...
func _Msg_VestingCession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgVestingCession)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).VestingCession(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chain4energy.c4echain.cfevesting.Msg/VestingCession",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).VestingCession(ctx, req.(*MsgVestingCession))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "VestingCession",
			Handler:    _Msg_VestingCession_Handler,
		},
	},
...
func (m *MsgVestingCession) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgVestingCession) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgVestingCession) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgVestingCessionResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgVestingCessionResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgVestingCessionResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgVestingCession) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgVestingCessionResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgVestingCession) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgVestingCession: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgVestingCession: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MsgVestingCessionResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgVestingCessionResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgVestingCessionResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
