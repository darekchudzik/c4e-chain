...
import { MsgVestingCession } from "./types/cfevesting/tx";
...
const types = [
  ...
  ["/chain4energy.c4echain.cfevesting.MsgVestingCession", MsgVestingCession],
...
const txClient = async (wallet: OfflineSigner, { addr: addr }: TxClientOptions = { addr: "http://localhost:26657" }) => {
  ...
  return {
    ...
    msgVestingCession: (data: MsgVestingCession): EncodeObject => ({ typeUrl: "/chain4energy.c4echain.cfevesting.MsgVestingCession", value: MsgVestingCession.fromPartial( data ) }),
